    ...
    return (
        <div className="flex items-center gap-2">
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64 bg-zinc-900 border-zinc-800 p-2 max-h-[400px]">
                    <DropdownMenuLabel className="text-zinc-400 px-3 py-1.5">
                        ...
                        buckets.map((bucket) => (
                            ...
                            >
                                <div className="flex items-center gap-3 w-full">
                                    <Database02Icon className="w-4 h-4 shrink-0" />
                                    <div className="flex-1 min-w-0">
                                        <div className="text-sm font-medium truncate">{bucket.displayName}</div>
                                        <div className="text-xs text-zinc-500 truncate">{bucket.bucketName}</div>
                                    </div>
                                    {bucket.isDefault && (
